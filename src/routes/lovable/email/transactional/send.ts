  ...
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        // Verify the caller has a valid Supabase auth token OR the service role key
        // (service role allows internal server-side senders like submitAndMatch to dispatch
        // emails for anonymous form submissions).
